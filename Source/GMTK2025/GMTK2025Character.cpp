...
void AGMTK2025Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AGMTK2025Character::Look);
...
void AGMTK2025Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGMTK2025Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGMTK2025Character::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
